...
<head>
  ...
  <title>Login - DermClinic's Patient Management System</title>
...
<div class="login-box ">
  <div class="login-logo mb-4">
    <img src="dermclinic.jpg" class="img-thumbnail p-0 border sqaure" id="system-logo">
    <div class="text-center h2 mb-0">Welcome to DermClinic</div>
  </div>
  <!-- logoJ3S -->
